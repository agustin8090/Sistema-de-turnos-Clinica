    ...
    <div class="form-container">
        ...
        <div class="form-body">
            ...
            <div class="form-actions">
                <asp:Button ID="Agregar_Paciente" runat="server"
                    CssClass="btn btn-agregar"
                    Text="Agregar"
                    OnClick="Agregar_Paciente_Click" />

                <asp:Button ID="Cancelar_Paciente" runat="server"
                    CssClass="btn btn-cancelar"
                    Text="Cancelar" />

                <asp:Button ID="VolverMenu" runat="server"
                    CssClass="btn btn-cancelar"
                    Text="Volver al Menú"
                    OnClick="VolverMenu_Click" />
            </div>
